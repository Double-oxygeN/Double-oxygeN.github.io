...
function clock()
{
	...
	leaper(ddd);
	dozenal1();
	dh = dozenal2(ddd.getHours());
	dm = dozenal2(ddd.getMinutes());
	ds = dozenal2(ddd.getSeconds());
	disp();
}
...
function dozenal2(hoge) {
	var dozen = parseInt(hoge / 12);
	var fuga = hoge % 12;
	switch(fuga) {
		case 10: r = "" + dozen + "#"; break;
		case 11: r = "" + dozen + "$"; break;
		default: r = "" + dozen + fuga; break;
	}
